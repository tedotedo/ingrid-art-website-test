...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-[#1a1a1a] text-white w-full z-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-4 py-5 items-center font-sans">
